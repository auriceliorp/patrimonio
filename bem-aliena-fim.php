...
if ( !$_POST[grava] ) {
	...
	//
	$qModifica = "SELECT a.*, b.Descricao, b.Obs, c.DescLocal, d.$FD_FUNC_NOME, d.$FD_FUNC_USERNAME2, d.$FD_FUNC_MAT
...
echo "<TD>{$bem}</TD>";
echo "<INPUT TYPE='hidden' NAME='numpat' VALUE='{$Dados['NumPat']},{$Dados['Inc']},{$Dados['Descricao']},{$Dados[$FD_FUNC_MAT]},{$Dados[$FD_FUNC_USERNAME2]}'>";
