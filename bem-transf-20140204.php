		...
		if ( !$rDuplica ) {
			...
			if ( $Qtde != 0 ) {
				...
				$msg = mail( "$usernovo[1]@ctaa.embrapa.br",
						...
						"1- Na Intranet, vá para a seção Atividades em andamento e clique sobre o nome do patrimônio para abrir o sistema de Controle de bens patrimoniais;\n" .
						"2- No sistema, clique sobre o nome do patrimônio desejado e siga as instruções existente.\n" .
						"Caso existam mais de um bem a receber, não saia da aplicação e repita os passos 1-2.",
