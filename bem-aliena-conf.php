...
if ( !$_POST['grava'] ) {
	...
	//
	$qModifica = "SELECT a.*, b.Descricao, c.DescLocal, d.$FD_FUNC_NOME, d.$FD_FUNC_MAT, d.$FD_FUNC_USERNAME2
...
echo "<TD>$desc</TD>";
echo "<INPUT TYPE='hidden' NAME='numpat' VALUE='$Dados[NumPat],$Dados[Inc],$Dados[Descricao],$Dados[Matricula],$Dados[Username2]'>";
echo "</TR>";
