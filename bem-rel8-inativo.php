...
//	Modulo: Listagem - Empregados INATIVOS sem bens patrimoniais
...
echo "<HR>";
echo "<CENTER>";
echo "<H2>Empregados inativos ou ex-empregados com bens patrimoniais sob sua responsabilidade</H2>\n";
echo "</CENTER>";

echo "<P>Clique sobre o nome da pessoa para visualizar os bens sob a sua responsabilidade.</P>";
...
//
//	Com link para o script "bem-rel2.php" que imprimirá o termo do escolhido
//
WHILE ( $dFunc = mysql_fetch_array( $rFunc ) ) {
		echo "<TR>";
		echo "<TD WIDTH='15%' align='center'>$dFunc[$FD_FUNC_MAT]</TD>";
		echo "<TD WIDTH='85%'><a href='./bem-rel2.php?escolhido=$dFunc[$FD_FUNC_MAT],$dFunc[$FD_FUNC_NOME]'>$dFunc[$FD_FUNC_NOME]</a></TD>";
		echo "</TR>";
}
echo "</TABLE>";
